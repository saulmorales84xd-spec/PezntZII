...
public class AdrenalinaHandRenderer {
    ...
    public static void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        boolean usingMedkit = player != null
                && player.isUsingItem()
                && player.getUseItem().getItem() instanceof Adrenalina;

        Adrenalina.setPlayingUseAnimation(usingMedkit);
    }
    ...
    public static void onRenderHand(RenderHandEvent event) {
        ...
        boolean holding = mainHand.getItem() instanceof Adrenalina;

        boolean cachedIsMedkit = event.getItemStack().getItem() instanceof Adrenalina;

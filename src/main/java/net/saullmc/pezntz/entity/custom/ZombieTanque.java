...
public class ZombieTanque extends Zombie {
    ...
    private static final EntityDataAccessor<Integer> DATA_VARIANT = SynchedEntityData.defineId(ZombieTanque.class, EntityDataSerializers.INT);
    ...
    public ZombieTanque(EntityType<? extends Zombie> pEntityType, Level pLevel) {
